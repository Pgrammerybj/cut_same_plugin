 ...
 * @desc: 音频+歌词贴纸
 */
class AudioNLEHandler(editorContext: IEditorContext) : BaseNLEHandler(editorContext),
    IAudioNLEHandler {
    ...
    override fun addLyricsStickerTrack(param: AudioParam): Boolean {
        ...
        val slot = NLETrackSlot().apply {
            ...
            mainSegment = NLESegmentSubtitleSticker().apply {
                ...
                effectSDKFile = NLEResourceNode().apply {
                    resourceFile = LocalSubtitleStickerPath.SUBTITLE_JINGDIAN
                ...
                style = NLEStyText().apply {
                    ...
                    font = NLEResourceNode().apply {
                        resourceFile = LocalSubtitleStickerPath.SUBTITLE_JINGDIAN_FONT_PATH
        ...
        executeCommit(CommitLevel.COMMIT)
        return true
    }
}