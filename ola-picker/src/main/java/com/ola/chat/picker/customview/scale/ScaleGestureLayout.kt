...
import com.ola.chat.picker.customview.ClipFrameLayout
...
constructor(
    ...
    private val listener = object : CombinationGestureListener {
        ...
        override fun onScaleBegin(detector: com.ola.chat.picker.customview.gesture.ScaleGestureDetector): Boolean {
            //防止和父布局ViewPager事件冲突
            parent.requestDisallowInterceptTouchEvent(true)
        ...
        override fun onScale(detector: com.ola.chat.picker.customview.gesture.ScaleGestureDetector): Boolean {
        ...
        override fun onScaleEnd(detector: com.ola.chat.picker.customview.gesture.ScaleGestureDetector) {
