...
import kotlinx.android.synthetic.main.activity_picker_segment.view.*
import java.util.*
...
class PickingListAdapter(
    ...
    override fun onBindViewHolder(holder: PickingItemHolder, position: Int) {
        ...
        loadThumbnail(data, holder.itemView.iVThumb) {
