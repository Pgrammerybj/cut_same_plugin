...
public interface EffectContract {
    ...
    interface View extends IView {
        PreviewFragment.EffectType getEffectType();
    }
    ...
    abstract class Presenter extends BasePresenter<View> {
        ...
        /**
         * 移除某一种类型的 progress，逻辑同上
         * @param map map
         * @param type type
         */
        abstract public void removeTypeInMap(SparseIntArray map, int type);
        ...
        abstract public SparseArray<ComposerNode> addDefaultReshapeNodes(SparseArray<ComposerNode> composerNodeMap);
        abstract public SparseArray<ComposerNode> addDefaultBodyNodes(SparseArray<ComposerNode> composerNodeMap);
        abstract public SparseArray<ComposerNode> addDefaultMakeupNodes(SparseArray<ComposerNode> composerNodeMap);
    }
}
