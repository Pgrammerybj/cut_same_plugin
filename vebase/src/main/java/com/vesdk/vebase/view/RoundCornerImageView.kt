...
class RoundCornerImageView : ImageView {
    ...
    private fun getRadius(context: Context, attrs: AttributeSet?): Int {
        val ta = context.theme.obtainStyledAttributes(attrs, R.styleable.CutRoundCornerView, 0, 0)
        val radius = ta.getDimensionPixelSize(R.styleable.CutRoundCornerView_cutradius, 0)
        ta.recycle()
        return radius
    }
    ...
    override fun draw(canvas: Canvas) {
        ...
        try {
            ...
            // TODO: zhangyeqi: DouyinFrescoImageService may recycle bitmap ?
        }
    }
}