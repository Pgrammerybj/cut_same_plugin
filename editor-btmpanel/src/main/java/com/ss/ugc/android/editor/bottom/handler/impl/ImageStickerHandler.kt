 ...
 * @date: 2021/3/30
 */
class ImageStickerHandler(activity: FragmentActivity, @IdRes containerId: Int) : BaseFunctionHandler(activity, containerId) {

    private val handleTypeList = mutableListOf(FunctionType.TYPE_FUNCTION_IMAGE_STICKER)
    ...
    override fun onHandleClicked(funcItem: FunctionItem) {
        showFragment(ImageStickerFragment())
    }
}
