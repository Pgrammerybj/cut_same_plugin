...
class AdjustItemViewHolder(context: Context) : BaseTrackItemHolder<AdjustItemView>(context) {
    override val itemView: AdjustItemView =
        AdjustItemView(context)
}

class AdjustItemView @JvmOverloads constructor(
    context: Context,
    ...
    companion object {
        ...
        private val ADJUST_FILTER_COLOR = Color.parseColor("#8342E3")
    ...
    override fun setSegment(slot: NLETrackSlot) {
        ...
        NLESegmentFilter.dynamicCast(mainSegment)?.let {
            text = it.filterName
            bgColor = ADJUST_FILTER_COLOR
        }
