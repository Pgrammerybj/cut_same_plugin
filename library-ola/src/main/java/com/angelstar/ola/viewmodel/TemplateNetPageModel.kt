package com.angelstar.ola.viewmodel
...
class TemplateNetPageModel(val category: TemplateCategory) : ViewModel() {
    ...
    fun loadFeedList(refresh: Boolean = false) {
        ...
        fetcher?.loadTemplateList(TEMPLATE_LIST_PATH, category, nextCursor, extraMap = extraRequestParams, callback = object : TemplateLoadCallback {
            override fun onSuccess(templateList: List<TemplateItem>, hasMore: Boolean, nextCursor: Int) {
