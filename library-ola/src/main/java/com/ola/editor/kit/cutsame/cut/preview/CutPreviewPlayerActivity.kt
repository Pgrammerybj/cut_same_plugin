...
import com.ola.editor.kit.cutsame.customview.OnFloatSliderChangeListener
import com.ola.editor.kit.cutsame.customview.setGlobalDebounceOnClickListener
import com.ola.editor.kit.cutsame.cut.adapter.MaterialPagerAdapter
import com.ola.editor.kit.cutsame.cut.lyrics.PlayerMaterialLyricsView
import com.ola.editor.kit.cutsame.cut.textedit.PlayerAnimateHelper
...
import com.ola.editor.kit.cutsame.cut.textedit.controller.PlayerTextEditController
import com.ola.editor.kit.cutsame.cut.textedit.listener.PlayerTextEditListenerAdapter
import com.ola.editor.kit.cutsame.cut.textedit.listener.PlayerTextItemThumbBitmapListener
...
import com.ola.editor.kit.cutsame.utils.showErrorTipToast
...
class CutPreviewPlayerActivity : CutPlayerActivity() {
    ...
    private fun onFloatSliderChangeListener() = object : OnFloatSliderChangeListener() {
        ...
        override fun onFreeze(value: Int) {
            com.ola.editor.kit.cutsame.utils.runOnUiThread(200L) {
                moveProgress = false
            }
            if (isForeground) {
...
//            launchCompile()
    ...
    private fun changePlayIcon(value: Boolean) = runOnUiThread {
        ...
        playStatusBtn.setImageResource(if (value) R.mipmap.icon_video_stop else R.mipmap.icon_video_play)
    }
