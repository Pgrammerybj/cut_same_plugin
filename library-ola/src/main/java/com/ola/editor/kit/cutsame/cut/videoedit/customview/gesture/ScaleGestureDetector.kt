...
import com.ola.editor.kit.cutsame.cut.videoedit.customview.gesture.ScaleGestureDetector.OnScaleGestureListener
...
class ScaleGestureDetector(private val mListener: OnScaleGestureListener) {
    ...
    private fun setContext(view: View, curr: MotionEvent) {
        ...
        if (prevIndex0 < 0 || prevIndex1 < 0 || currIndex0 < 0 || currIndex1 < 0) {
            ...
            LogUtil.e(TAG, "Invalid MotionEvent stream detected.")
            if (isInProgress) {
                mListener.onScaleEnd(view, this)
            }
            return
